...
export default function Sidebar() {
    const { currentView, selectedStory, actions } = useStoryCrafterStore(s => s.setCurrentView && s);
    ...
    return (
        <div className="w-48 lg:w-56 bg-gray-50 border-r border-gray-100 p-4 lg:p-8">
            ...
            <nav className="space-y-1.5">
                <button
                    onClick={() => actions.setCurrentView('story-detail')}
                ...
                <button
                    onClick={() => actions.setCurrentView('world')}
                    className={`w-full text-left px-3 lg:px-4 py-2 lg:py-2.5 rounded-lg text-sm lg:text-base transition-colors ${
                        currentView === 'world'
                            ? 'bg-gray-100 text-gray-900 font-medium'
                            : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
                ...
                <div className="mt-8 lg:mt-12 pt-6 lg:pt-8 border-t border-gray-200">
                    <button
                        onClick={() => actions.showConfirm(
                            ...
                            () => actions.deleteStory(selectedStory.id)
                        )}
